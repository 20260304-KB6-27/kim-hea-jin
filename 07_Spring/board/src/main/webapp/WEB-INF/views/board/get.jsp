...
<div class="mt-4">
    ...
    <a href="#" class="btn btn-primary delete"><i class="fas fa-trash-alt"></i> 삭제</a>  <!-- main.js로 이동-->
</div>

<form action="delete" method="post" id="deleteForm">
    <input type="hidden" name="no" value="${board.no}">  <!-- BoardController.java로 delete post요청 보냄(no 데이터 가지고) -->
</form>
